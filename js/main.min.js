...
"use strict";var SLIDER=new Swiper(".page",{wrapperClass:"page__wrapper",slideClass:"page__screen",direction:"vertical",mousewheel:{sensitivity:1},keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0},speed:800}),numOfSliders=document.querySelectorAll(".page__screen").length-1,pointerCircles=document.querySelectorAll(".cls-3");function addActiveClass(e){e.forEach(function(e,n){e.classList.contains("active")||e.classList.add("active")})}function windowLoad(){addActiveClass(pointerCircles)}window.addEventListener("load",windowLoad),SLIDER.on("slideChange",function(){console.log(SLIDER.activeIndex)});
